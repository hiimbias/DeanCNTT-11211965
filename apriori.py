...
def show_frequent_itemsets():
    ...
    if frequent_itemsets:
        ...
        for itemset in frequent_itemsets:
            frequent_itemsets_text.insert(tk.END, f"Items: {', '.join(itemset[0])}\nSupport: {itemset[1]:.4f}\nConfidence: {itemset[2]:.4f}\nLift: {itemset[3]:.4f}\n\n")
...
# my_basket = load_and_preprocess_data("bread basket (1).csv")
...
# frequent_itemsets_text = tk.Text(root, height=30, width=60, state=tk.DISABLED)  # Increase the width
